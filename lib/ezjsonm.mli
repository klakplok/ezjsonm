...
val bool: bool -> [> `Bool of bool]
(** Same as [`Bool b]. *)

val string: string -> [> `String of string]
(** Same as [`String s]. *)

val strings: string list -> [> `A of value list]
...
val float: float -> [> `Float of float]
(** Some as [`Float f]. *)

val list: ('a -> [< value]) -> 'a list -> [> `A of value list]
(** Build a list of values. *)

val option: ('a -> [< value]) -> 'a option -> [> value ]
(** Either [`Null] or a JSON value. *)

val dict: (string * [< value]) list -> [> `O of (string * value) list]
(** Build a dictionnary. *)

val pair: ('a -> [< value]) -> ('b -> [< value]) -> ('a * 'b) -> [> `A of value list]
(** Build a pair. *)

val triple: ('a -> [< value]) -> ('b -> [< value]) -> ('c -> [< value]) ->
  ('a * 'b * 'c) -> [> `A of value list]
(** Build a triple. *)
